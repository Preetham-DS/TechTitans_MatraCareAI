  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 p-4 bg-pink-600 text-white rounded-full shadow-2xl hover:bg-pink-700 transition-all z-50 ${isOpen ? 'hidden' : 'flex'}`}
      >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 w-80 sm:w-96 bg-slate-50 border border-gray-200 shadow-2xl rounded-2xl flex flex-col z-50 overflow-hidden h-[500px] max-h-[80vh]">
          {/* Header */}
