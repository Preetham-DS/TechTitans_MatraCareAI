      ...
      <div className="relative w-full max-w-md bg-white rounded-[2rem] shadow-2xl p-8 overflow-hidden transform transition-all">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 disabled:opacity-60 text-white py-3.5 rounded-2xl font-bold shadow-lg transition-all hover:shadow-xl transform hover:-translate-y-0.5 mt-2"
          >
            {isLoading ? (
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          {mode === 'login' ? (
            <p>
              ...
              <button onClick={() => switchMode('signup')} className="text-pink-600 font-bold hover:underline">
                Sign up
              </button>
            </p>
          ) : mode === 'signup' ? (
            <p>
              ...
              <button onClick={() => switchMode('login')} className="text-pink-600 font-bold hover:underline">
                Log in
              </button>
            </p>
          ) : (
